...
function _vidOvMenuItem(v,steps,focusSet){
  ...
  const _addBtn=`<div onclick="event.stopPropagation();_vidOvInlineAdd('${sid}',null,null,this.closest('[data-vidrow]'))" style="width:12px;min-width:12px;max-width:12px;height:12px;min-height:12px;max-height:12px;display:flex;align-items:center;justify-content:center;align-self:center;border-radius:2px;border:1px solid ${_onCal?'var(--accent)':'var(--border)'};background:var(--bg);color:${_onCal?'var(--accent)':'var(--muted)'};cursor:pointer;flex-shrink:0;flex-grow:0;box-sizing:border-box;overflow:hidden" title="Add small video"><svg width="7" height="7" viewBox="0 0 7 7" style="display:block;flex-shrink:0" fill="none" stroke="currentColor" stroke-width="1.3" stroke-linecap="round"><line x1="3.5" y1="1" x2="3.5" y2="6"/><line x1="1" y1="3.5" x2="6" y2="3.5"/></svg></div>`;
