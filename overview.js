...
function _vidOvMenuItem(v,steps,focusSet){
  ...
  const _postField=`<div class="vid-ov-post" style="width:28px;flex-shrink:0;display:flex;align-items:center;justify-content:flex-end;align-self:stretch;cursor:pointer" onclick="event.stopPropagation();_vidOvEditPostDate('${sid}',this)" ondblclick="event.stopPropagation();_vidOvEditPostDate('${sid}',this)" title="${v.post_date||'Set post date'}"><span style="font-size:9px;font-variant-numeric:tabular-nums;font-family:system-ui,-apple-system,sans-serif;color:${_postColor};line-height:1">${_postDate||''}</span></div>`;
  ...
  children.forEach((c,ci)=>{
    ...
    const _cPostField=`<div class="vid-ov-post" style="width:28px;flex-shrink:0;display:flex;align-items:center;justify-content:flex-end;align-self:stretch;cursor:pointer" onclick="event.stopPropagation();_vidOvEditPostDate('${csid}',this)" ondblclick="event.stopPropagation();_vidOvEditPostDate('${csid}',this)" title="${c.post_date||'Set post date'}"><span style="font-size:9px;font-variant-numeric:tabular-nums;font-family:system-ui,-apple-system,sans-serif;color:${_cPostColor};line-height:1">${_cPostDate||''}</span></div>`;
