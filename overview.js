...
function _vidOvMenuItem(v,steps,focusSet){
  ...
  const _addBtn=`<div onclick="event.stopPropagation();_vidOvInlineAdd('${sid}',null,null,this.closest('[data-vidrow]'))" style="font-size:11px;font-weight:400;width:14px;height:14px;display:flex;align-items:center;justify-content:center;line-height:1;border-radius:2px;border:1px solid ${_onCal?'var(--accent)':'var(--border)'};background:var(--bg);color:${_onCal?'var(--accent)':'var(--muted)'};cursor:pointer;flex-shrink:0;box-sizing:border-box" title="Add small video">+</div>`;
...
function _vidOvInlineAdd(bigId,orderBefore,orderAfter,afterEl){
  ...
  row.innerHTML=`<div style="width:14px;flex-shrink:0;box-sizing:border-box;border:1px solid transparent;display:flex;align-items:center;justify-content:center;color:rgba(140,135,160,.4);font-size:9px">└</div><input type="text" placeholder="Video topic..." style="flex:1;min-width:0;border:none;outline:none;background:transparent;font-size:11px;color:var(--text);font-weight:500;padding:3px 4px;border-radius:4px;box-shadow:inset 0 0 0 1px rgba(14,165,233,.3)">`;
