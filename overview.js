...
function renderWkCal(){
  ...
  dates.forEach((date,di)=>{
    ...
    dayTasks.forEach(t=>{
      ...
      const nm=document.createElement('span');nm.className='chip-name';nm.innerHTML=tmIcon(t)+escHtml(t._type==='pup'?_pupDisplayName(t):t.name)+(_chipHeb?`<span style="color:rgba(180,170,210,.7);margin-left:3px;font-weight:600">${_chipHeb}</span>`:'');
