...
function _vidOvMenuItem(v,steps,focusSet){
  ...
  const _countBadge=_smallCount?` <span style="font-size:10px;font-weight:500;color:var(--muted);display:inline-flex;align-items:center">· ${_smallCount}</span>`:'';
