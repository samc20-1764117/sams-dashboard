...
function renderDayTB(){
  ...
  HOURS.forEach(h=>{const l=document.createElement('div');l.className='tb-tlbl';l.textContent=h===12?'12p':h>12?`${h-12}p`:`${h}a`;if(_isWkday&&(h===8||h===16)){l.style.color=_dk()?'rgba(255,220,200,.4)':'rgba(120,90,60,.45)';l.style.fontWeight='700';}gut.appendChild(l);});
