...
function renderPupSkillsHighlight(){
  ...
  const mkTile=(pup,skills,accentColor)=>{
    ...
    const progressBar=`<div style="height:3px;background:rgba(0,0,0,.06);margin:4px 10px 3px;border-radius:2px;overflow:hidden"><div style="height:100%;width:${pct}%;background:#10b981;border-radius:2px;transition:width .3s"></div></div>`;
