  ...
  el.innerHTML=`
    ...
    <div style="padding-top:4px">
      <div style="display:flex;gap:10px;align-items:center;margin-bottom:4px;flex-wrap:wrap">
        ...
        <button onclick="openVidModal()" style="background:rgba(255,255,255,.18);border-radius:20px;padding:4px 8px;display:flex;align-items:center;gap:4px;font-size:12px;border:none;cursor:pointer;margin-right:90px" title="Add video">
