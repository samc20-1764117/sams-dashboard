...
function renderVideosPage(){
  ...
  el.style.cssText='padding:41px clamp(12px,3vw,56px) calc(clamp(12px,3vw,56px) + 36px) clamp(12px,3vw,56px);display:flex;flex-direction:column;height:100vh;box-sizing:border-box;width:100%';
  el.innerHTML=`
