...
function _vidDashRow(v,isChild,simple){
  ...
  const _kidBadge=_kidCount?'<span style="font-size:9px;color:var(--muted);font-weight:400;margin-left:4px;vertical-align:middle">'+_kidCount+'</span>':'';
