...
function _vidDashRow(v,isChild,simple){
  ...
  const _kidBadge=_kidCount?'<span style="font-size:9px;color:rgba(160,155,180,.55);font-weight:400;margin-left:4px;vertical-align:middle;line-height:1;display:inline-flex;align-items:center">'+_kidCount+'</span>':'';
